              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative w-32 h-32 mb-2 rounded-full overflow-hidden shadow-lg">
                    <Image src="/images/IMG_9834.jpg" alt="Andrew Ugarte" fill className="object-cover" style={{ objectPosition: 'center 60%' }} />
                  </div>
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative w-32 h-32 mb-2 rounded-full overflow-hidden shadow-lg">
                    <Image src="/images/IMG_9857.jpg" alt="Elijah Ramirez" fill className="object-cover" style={{ objectPosition: 'center 20%' }} />
                  </div>
